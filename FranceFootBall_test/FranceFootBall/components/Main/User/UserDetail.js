...
//let url = 'http://192.168.0.8:8797/rooms/update/';
let url = 'http://192.168.43.159:8797/rooms/update/';
...
const UserDetail2 = ({route}) => {
    ...
    const {nameCustomer} = route.params;
                ...
                <Text style = {styles.title}>{content}</Text>
                    ...
                    <View style = {styles.infoRoomBottom}>
                        <View style = {styles.introduce}>
                            ...
                            <Text style = {styles.text2}>{blog}</Text>
                            <View style = {styles.textname}><Text style = {styles.text1}>Người đăng : {nameCustomer}</Text></View>
