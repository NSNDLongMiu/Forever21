    ...
    return (
        <ImageBackground source={image} style = {styles.imagebg}>
            ...
            <View style={styles.down}>
                ...
                <TouchableOpacity style={styles.loginButton} onPress={() => admindetail()}>
                    <Text style={styles.loginButtonTitle}>ĐĂNG BÀI VIẾT</Text>
                </TouchableOpacity>

                <TouchableOpacity style={styles.loginButton} onPress={() => adminupdate()}>
                    <Text style={styles.loginButtonTitle}>XEM TIN TỨC TRONG TUẦN</Text>
                </TouchableOpacity>

                <TouchableOpacity style={styles.loginButton} onPress={() => adminday()}>
                    <Text style={styles.loginButtonTitle}>XEM TIN TỨC TRONG NGÀY</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.loginButton} onPress={() => admindelete()}>
